/* Vendored from musl 1.2.5, internal/intscan.c.
 *
 ...
 */
/* Edits: the shgetc header is the port's (guest_scanf.c), not musl's. *   * every `FILE` is the string pseudo-FILE of gshgetc.h (`GFILE`).
 */
...
unsigned long long __intscan(GFILE *f, unsigned base, int pok, unsigned long long lim)
{
