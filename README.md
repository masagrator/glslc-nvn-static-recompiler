...
Naive in the sense that it generates tons of false functions that are never used which can generate executable size even 6x bigger than ELF. But it's still faster than running this elf through Unicorn via Python.
